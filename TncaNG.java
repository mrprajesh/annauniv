...
public class TncaNG {
	...
	static String folder="TNCA 2016 NG/";
	...
	public static void getSessionData(){
		try{
			FileInputStream fstream = new FileInputStream("NGColl.txt");
	...
	public static boolean getWebpage(String cid){
		...
		try {
			...
			String httpsURL = "https://www.annauniv.edu/cgi-bin/vactanca16/vacngate.pl";
