...
public class Barch {
	...
	public static void doFormatText(String cid){
		...
		try{
			...
			for (int i= 0; (strLine = br.readLine()) != null ; i++)   {
				if(strLine.startsWith("<h3 align=")){
					dateSession = strLine.substring(strLine.indexOf("as on ")+6,strLine.indexOf("</u>"));	
	...
	public static boolean getWebpage(String cid){
		...
		try {
			...
			String httpsURL = "https://www.annauniv.edu/cgi-bin/vacancy16/arraytotbarch.pl";
